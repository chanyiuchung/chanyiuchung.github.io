...
var fnName=function(){
	   if(browser.versions.android || browser.versions.iPhone){//如果是移动终端
		   location.href = "http://www.yaozong.info/mobile.html";
		   }
	}()
...
//		}s
		...
		function yi() {
			...
			//动态打字动画--------------------------------------------------------
			var arr = ["C", "Y", "Z","(",")", "<br>", "{", "<br>", "&nbsp&nbsp&nbsp&nbsp", "r", "e", "t", "u", "r", "n", "&nbsp&nbsp", "\"", "程", "序", "猿", "\"", ";", "<br>", "}", ];
			var num = 0;
			var str = "";
			setTimeout(function() {
		...
		function zidong() {
			var arr1 = ["y", "a", "o", "z", "o", "n", "g", ".", "i", "n", "f","o", ];
			var num1 = 0;
			var str1 = "";
			setTimeout(function() {
